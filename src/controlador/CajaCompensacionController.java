...
public class CajaCompensacionController {
    ...
    private static final String RUTA_BACKUP = "src/backup";
    ...
    private void editarDatos() {
        ...
        if (selectedRow == -1) {
            JOptionPane.showMessageDialog(vista, "Selecciona una fila para editar.", "Error",
    ...
    private void eliminarDatos() {
        int selectedRow = vista.getTable().getSelectedRow();
        if (selectedRow == -1) {
            JOptionPane.showMessageDialog(vista, "Selecciona una fila para eliminar.", "Error",
                    JOptionPane.ERROR_MESSAGE);
            return;
        }
