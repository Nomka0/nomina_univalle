...
public class ConfigEmpresaControlador {
    ...
    private ConfigEmpresaDAO dao = new ConfigEmpresaDAO();
    
    public ConfigEmpresaControlador(ConfigEmpresaVista vista) {
        this.vista = vista;
        ...
        this.vista.agregarVolverListener(new VolverListener());
    }
